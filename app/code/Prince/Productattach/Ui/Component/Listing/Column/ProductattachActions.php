...
/**
 * Class ProductattachActions
 * @package Prince\Productattach\Ui\Component\Listing\Column
 */
class ProductattachActions extends \Magento\Ui\Component\Listing\Columns\Column
{
    ...
    /**
     * ProductattachActions constructor.
    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                if (isset($item['productattach_id'])) {
