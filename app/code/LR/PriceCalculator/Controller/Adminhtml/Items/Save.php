...
class Save extends \LR\PriceCalculator\Controller\Adminhtml\Items
{
            ...
            try {
                ...
                if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                    try{
                        ...
                        $destinationPath = $mediaDirectory->getAbsolutePath('lr/pricecalculator');
                        ...
                        $imagePath = 'lr/pricecalculator'.$result['file'];
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('lr_pricecalculator/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('lr_pricecalculator/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('lr_pricecalculator/*/new');
                }
                return;
            } catch (\Exception $e) {
