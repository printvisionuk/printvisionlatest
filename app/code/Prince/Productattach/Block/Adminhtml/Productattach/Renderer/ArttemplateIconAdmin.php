 ...
 */
class ArttemplateIconAdmin extends \Magento\Framework\Data\Form\Element\AbstractElement
{
    ...
    public function getElementHtml()
    {
        ...
        if ($file) {
            ...
            $fileIcon .= "<a href='".$this->urlBuilder->getUrl(
                'productattach/index/deletearttemplate', $param = ['productattach_id' => $attachId])."'>
