    ...
    public function aroundGetValuesHtml(Select $subject, \Closure $proceed)
    {
        ...
        foreach ($option->getValues() as $value) {
            ...
            if ($element) {
                ...
                {
                    $element->setAttribute("data-option_percent_value", $value->getPrice());        
                }
                
                $element->setAttribute("data-option_type_id", $value->getOptionTypeId());
                $element->setAttribute("data-option_sku", $value->getSku() ?? '');
                //$element->setAttribute("data-use_in_upload", $value->getUseInUpload() ?? '');
            }
        }
