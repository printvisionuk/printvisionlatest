 ...
 */
namespace Webkul\JobBoard\Model\ResourceModel\Job\Grid;
...
use Webkul\JobBoard\Model\ResourceModel\Job\Collection as JobCollection;
...
class Collection extends JobCollection implements SearchResultInterface
{
    ...
    {
        $jobboardTable = $this->getTable('wk_jobboard_category');
        $this->getSelect()->joinLeft(
            ['wjc' => $jobboardTable],
            'wjc.entity_id = main_table.category',
            ['jobcategory' => "wjc.name"]
        );
    ...
    {
        $this->addFilterToMap('jobcategory', 'wjc.name');
