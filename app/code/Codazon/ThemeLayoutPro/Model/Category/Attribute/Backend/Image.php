 ...
 */
namespace Codazon\ThemeLayoutPro\Model\Category\Attribute\Backend;
...
class Image extends \Magento\Eav\Model\Entity\Attribute\Backend\AbstractBackend
{
    ...
    public function beforeSave($object)
    {
        ...
        //         if (stripos($newImgRelativePath, $this->imageUploader->getBasePath()) === false) {
        //             $newImgRelativePath = $this->imageUploader->getBasePath() . '/' .  $newImgRelativePath;
        //             $value[0]['file'] = $newImgRelativePath;
        //         }
        ...
        //     if (stripos($value[0]['url'], 'http') !== false) {
        //         $value[0]['url'] = $baseMediaDir . '/'. $this->imageUploader->getBasePath(). '/' . $value[0]['name'];//parse_url($value[0]['url'], PHP_URL_PATH);
        //     }
        //     $value[0]['name'] = $value[0]['url'];
        //     //parse_url($value[0]['url'], PHP_URL_PATH);
        // }
