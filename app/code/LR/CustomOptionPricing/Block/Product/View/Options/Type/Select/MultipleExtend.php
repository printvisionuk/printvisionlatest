...
namespace LR\CustomOptionPricing\Block\Product\View\Options\Type\Select;

use Magento\Catalog\Block\Product\View\Options\AbstractOptions;
use Magento\Catalog\Model\Product\Option;
use Magento\Framework\View\Element\Html\Select;

class MultipleExtend extends \Magento\Catalog\Block\Product\View\Options\Type\Select\Multiple
{
    ...
    protected function _toHtml()
    {
        ...
        /** @var Select $select */
        $pricingClass = '';
        if($option->getIsCustomPricing())
            $pricingClass = ' custom-pricing';
        ...
        $select = $this->getLayout()->createBlock(
            ...
            [
                ...
                'class' => $require .$pricingClass.' product-custom-option admin__control-select'
            ]
        );
