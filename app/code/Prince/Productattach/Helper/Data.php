...

{
    ...
    * @return bool|string
    */
    public function uploadFileArttemplate($scope, $model)
    {
        ...
        try {
            ...
            $uploader->setAllowCreateFolders(true);
            if ($uploader->save($this->getBaseDir())) {
                $model->setArttemplate($uploader->getUploadedFileName());
                $model->setArttemplateExt($uploader->getFileExtension());
            }
            } catch (\Exception $e) {
        }
        return $model;
...

    {
        ...
        return ['pdf','indt','ai','pptx', 'xls', 'xlsx', 'flash', 'mp3', 'docx', 'doc', 'zip', 'jpg', 'jpeg', 'png', 'gif', 'ini', 'readme', 'avi', 'csv', 'txt', 'wma', 'mpg', 'flv'];
